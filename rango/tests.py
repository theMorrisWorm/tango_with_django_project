...
class Chapter4StaticMediaTests(TestCase):
    ...
    def test_static_and_media_configuration(self):
        ...
        self.assertEqual(expected_path, media_path,
                         f"{FAILURE_HEADER}The MEDIA_DIR setting does not point to the correct path. Remember, "
                         f"it should have an absolute reference to tango_with_django_project/media/.{FAILURE_FOOTER}")
